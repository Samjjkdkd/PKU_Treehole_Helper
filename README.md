...
扩展集成了多种AI辅助功能，利用大语言模型提升您的树洞使用体验。
...
2. 切换到"设置"标签
3. 在"AI功能设置"部分：
   - 选择AI平台（支持智谱AI和DeepSeek）
   - 选择具体模型（如GLM-4, GLM-4-Flash等）
   - 输入您的API密钥
4. 点击"保存设置"按钮

**树洞自动分类：**

此功能可以自动对树洞内容进行智能分类，帮助您快速识别不同类型的讨论。

1. 在树洞首页收集数据后，点击"批量分类"按钮
2. 系统会自动分析当前显示的树洞内容并进行分类
3. 分类结果将直接显示在每个树洞标题旁，不同类别使用不同颜色标识：
   - 聊天：popi、交友、社交相关内容
   - 提问：求助，提问的相关内容
   - 情感：情绪表达、情感分享
   - 学习：学术、课程、科研相关
   - 生活：日常生活、校园生活
   - 其他：不属于以上类别的内容
4. 您可以随时停止分类过程，已分类的结果将保留

**树洞内容总结：**

此功能可以智能总结树洞的讨论内容，帮助您快速了解长篇讨论的主要观点。

1. 在树洞详情页，收集评论后
2. 点击"总结树洞"按钮
3. 系统将分析所有评论并生成一个简洁的总结
4. 总结完成后，您可以：
   - 阅读生成的总结内容
   - 使用提供的复制按钮将总结复制到剪贴板
   - 随时点击"重新总结"重新生成
...
此功能可以基于树洞内容生成合适的回复，帮助您更轻松地参与讨论。

1. 在树洞详情页，收集评论后
2. 点击"生成回复"按钮
3. 在"回复风格"下拉菜单中选择您想要的风格：
   - 友好帮助：提供支持和建设性意见
   - 幽默风趣：生成轻松幽默的回复
   - 刻薄嘲讽：表达刻薄攻击的言论
   - 简洁直接：简短明了地表达观点
...
- AI功能需要配置有效的API密钥才能使用
- 使用API可能产生费用，请关注您的API使用量
- 所有AI处理均在本地完成，您的数据不会发送到除了选定的AI服务商之外的任何服务器
- 总结和回复功能的质量取决于所选模型的能力，高级模型通常能提供更好的结果
...
**Q: 收集过程中浏览器变卡怎么办？**  
A: 目前没遇到过。但是如果遇到性能问题，建议设置较低的收集时间限制或数量限制，或取消自动滚动，改为手动滚动。
